...
public class flightBookingView extends JFrame implements ActionListener {
    ...
    String userName;
    public flightBookingView(String userName) {
        ...
        JLabel d = new JLabel("Flight Booking: ");
        ...
        JLabel feature = new JLabel("- FLIGHT FEATURES -");
        feature.setBounds(300, 40, 150, 50);

        feature.setFont(new Font("OSWALD", Font.BOLD, 15));
        p1.add(feature);

        JLabel ac = new JLabel("Extra Laguage                            : ");
        ...
        ImageIcon k = new ImageIcon(ClassLoader.getSystemResource("icons/travel.png"));
        Image k1 = k.getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT);
        ImageIcon k2 = new ImageIcon(k1);
        JLabel k3 = new JLabel(k2);
        k3.setBounds(300, 200, 100, 100);
        p1.add(k3);


        JLabel id_identify = new JLabel("No.of Person: ");
...
//        int acPrice = 25000, mealPrice = 5000, theatrePrice = 2000, hotelTourPrice = 10000, eagleViews = 9000;
        ...
        JLabel id = new JLabel("Select Flight        : ");
        id.setBounds(30, 75, 110, 50);
        p1.add(id);

        packagE = new Choice();
        packagE.add("Flight A");
        packagE.add("Flight B");
...
//        p1.add(image);
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == book) {
            ...
            try {
                Conn c = new Conn();
                c.s.executeUpdate("insert into flights values('"+username_fetch.getText()+"', '"+packagE.getSelectedItem()+"', '"+no_of_ppl.getText()+"', '"+lID.getText()+"', '"+country_fetch.getText()+"', '"+price_fetch.getText()+"')");
