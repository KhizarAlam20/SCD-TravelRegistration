...
public class loading_after_login extends JFrame implements Runnable {
    String username;
    Thread t;
    ...
    public loading_after_login(String username) {
