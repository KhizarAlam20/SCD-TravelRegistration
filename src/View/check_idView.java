...
public class check_idView extends JFrame implements ActionListener {
    JButton check, back;
    public JTextField idNUMBER;
    public JLabel email_fetch;
    public JTextField idNUMBER1;
    String userName;
    check_idView(String userName) {
