...
public class update_detailsView extends JFrame implements ActionListener {
    ...
    String userName;
    public update_detailsView(String userName) {
        this.userName = userName;
        System.out.println("Update usernme= "+  userName);
        ...
        JLabel d = new JLabel("UPDATE PERSONAL DETAILS: ");
...
//        
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            ...
            try {
                Conn c = new Conn();
                String query = "update customer set username = '" + username + "', id =  '" + id + "', number = '" + number + "', gender = '" + gender + "', country = '" + country + "', address = '" + address + "', mobile = '" + mobileNumber + "', email = '" + email + "'";
